...
This repository uses multiple test types so user-service-infrastructure changes are checked from configuration shape down to the developer CLI surface.
