...
def test_makefile_keeps_pulumi_guardrails_secret_safe() -> None:
    ...
    assert "destructive-gate .artifacts/pulumi-preview/*.json" in text
...
def test_operator_docs_are_present_and_indexed() -> None:
    ...
    assert "/home/dev/.venvs/user-service-infrastructure" not in docs_index
    assert "/home/dev/.venvs/user-service-infrastructure" not in root_readme
